...
export const ContactSection = forwardRef<HTMLElement, ContactSectionProps>(
    ({ darkMode, isVisible }, ref) => {
        ...
        const handleSubmit = async (e: React.FormEvent) => {
            ...
            try {
                await emailjs.send(
                    "service_akalanka", // your EmailJS service ID
                    "template_k9hzuto", // your EmailJS template ID
                    formData,
                    "H-EXgOIQuOmbaoyOt" // your EmailJS public key
                )
